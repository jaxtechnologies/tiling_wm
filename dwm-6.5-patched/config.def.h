...
static const char *fonts[]          = { "monospace:size=10", "terminus-font:size=12", "mononoki-nerd:size=12", "NotoColorEmoji:size=10:antialias=true:autohint=true" };
